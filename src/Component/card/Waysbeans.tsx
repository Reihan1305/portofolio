...
const Waysbeans = () => {
  return (
    <div className="bg-amber-800 rounded-xl py-10 px-10 flex items-start gap-10">
      <div className="sm:w-1/2 ">
        <div className="flex-column sm:hidden justify-center items-center mb-2">
          ...
          <p className="text-white font-bold text-justify">
            Ways Beans is an e-commerce website specifically for coffee beans
            that can connect sellers with buyers
          </p>
        </div>
        <img
          src="/waysbeans.png"
      ...
      <div className="hidden sm:block flex-column justify-start items-start w-1/2">
        <h1 className="text-black text-2xl font-bold text-start">Ways Beans</h1>
        <p className="text-white font-bold text-justify pe-20">
          Ways Beans is an e-commerce website specifically for coffee beans that
          can connect sellers with buyers
        </p>
        <div>
          <img
            src="/waysbeans2.png"
        ...
        <div className="mt-3">
          ...
          <div className="flex gap-5">
            <a
              href="https://github.com/Reihan1305/waysBeansBE"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://github.com/Reihan1305/waysBeansFE"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-black transition duration-300 ease-in-out flex items-end gap-2"
            >
